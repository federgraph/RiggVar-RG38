...
//    procedure XBoxClick(const Sender: TCustomListBox; const Item: TListBoxItem);
//    procedure YBoxClick(const Sender: TCustomListBox; const Item: TListBoxItem);
//    procedure PBoxClick(const Sender: TCustomListBox; const Item: TListBoxItem);
...
//  XBox.OnItemClick := XBoxClick;
//  PBox.OnItemClick := PBoxClick;
//  YBox.OnItemClick := YBoxClick;
...
//procedure TFormChart.XBoxClick(const Sender: TCustomListBox; const Item: TListBoxItem);
//begin
...
//procedure TFormChart.PBoxClick(const Sender: TCustomListBox; const Item: TListBoxItem);
//begin
//  ChartGraph.PComboItemIndex := PBox.ItemIndex;
//
//  if WantAutoUpdate then
...
//procedure TFormChart.YBoxClick(const Sender: TCustomListBox; const Item: TListBoxItem);
//begin

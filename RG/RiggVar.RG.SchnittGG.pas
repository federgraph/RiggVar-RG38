...
type
  ...
  private
    ...
    procedure SetE1(const Value: single);
    procedure SetE2(const Value: single);
  public
    constructor Create;
    property Radius1: single write SetR1;
    property Radius2: single write SetR2;
    property M1: TPointF write SetM1;
    property M2: TPointF write SetM2;
    property Angle1: single write SetA1;
    property Angle2: single write SetA2;
    property Elevation1: single write SetE1;
    property Elevation2: single write SetE2;
    property H1: single read FH1;
    property H2: single read FH2;
    property V1: single read FV1;
    property V2: single read FV2;
  end;
...
procedure TSchnittGGEx.SetA1(const Value: single);
var
  w: single;
  t: TPoint3D;
begin
...
procedure TSchnittGGEx.SetA2(const Value: single);
var
  w: single;
  t: TPoint3D;
begin
...
procedure TSchnittGGEx.SetR1(const Value: single);
var
  T: TPoint3D;
begin
  if Value > 0.5 then
...
procedure TSchnittGGEx.SetR2(const Value: single);
var
  T: TPoint3D;
begin
  if Value > 0.5 then
...
procedure TSchnittGGEx.SetE1(const Value: single);
begin
...
procedure TSchnittGGEx.SetE2(const Value: single);
begin
  if (Value >= -89) and (Value <= 89) then
  begin

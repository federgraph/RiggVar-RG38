...
type
  ...
  TRggCalc = record
    class function SchnittGG(P1, P2, P3, P4: TPoint3D; out SP: TPoint3D): Boolean; static;
    class function PsiVonPhi(phi, l1, l2, l3, l4: single; out sv: Boolean): single; static;
    class function StartWinkel(l1, l2, l3, l4: single; out sv: Boolean): single; static;
    class function Hoehe(a, b, c: single; out k: single): single; static;
  end;
...
class function TRggCalc.SchnittGG(P1, P2, P3, P4: TPoint3D; out SP: TPoint3D): Boolean;
var
  a1, a2: single;
...
class function TRggCalc.Hoehe(a, b, c: single; out k: single): single;
var
  t: single;
begin
  k := sqr(a) + sqr(b) - sqr(c);
...
class function TRggCalc.PsiVonPhi(phi, l1, l2, l3, l4: single; out sv: Boolean): single;
var
  a, b, c, Rad: single;
begin
  sv := True;
...
class function TRggCalc.StartWinkel(l1, l2, l3, l4: single; out sv: Boolean): single;
var
  cosphi: single;
  sw: single;
begin
